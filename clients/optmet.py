...
def main(date_from=date_from, date_to=date_to):
    ...
    ACCESS_TOKEN = 'AgAAAAAjPp0XAAahJf1jUVzCj0nFsZbXcBe-SO4'
    YANDEX_LOGIN = 'elama-16191152'
    CLIENT_NAME = 'Оптметаллобаза'
    ...
    yandex_report_campaigns = dh.get_report(login=YANDEX_LOGIN,
                                            ...
                                            report_name='OPTMETALLOBAZA_CAMPAIGN_REPORT',
                                            date_from=date_from,
                                            date_to=date_to)
    yandex_report_daily = dh.get_report(login=YANDEX_LOGIN,
                                        ...
                                        report_name='OPTMETALLOBAZA_DAILY_REPORT',
                                        date_from=date_from,
                                        date_to=date_to)
    ...
    worksheet_daily = sh.worksheet("Яндекс Директ по дням")
